package org.lessons.lesson5.deadlockexample.rightordersolution;

import org.lessons.lesson5.deadlockexample.Resource;

public class DeadlockSolutionWithRightOrder {
    public static void main(String[] args) {
        ...
        Thread t2 = new Thread(() -> {
            synchronized (resource1) {
                System.out.println("Thread 2: Захватил " + resource1.getName());
                ...
                System.out.println("Thread 2: Ожидает " + resource2.getName());
                synchronized (resource2) {
